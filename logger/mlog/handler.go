...
// FuncHandler returns a Handler that logger records with the given
// function.
...
// package github.com/wooyang2018/corechain/logger/mlog for the list of supported formats.
func CallerStackHandler(format string, h Handler) Handler {
	return FuncHandler(func(r *Record) error {
		s := StackTrace().TrimBelow(r.Call).TrimRuntime()
		if len(s) > 0 {
