...
func (t *xModSnapshot) Get(bucket string, key []byte) (*ledger.VersionedData, error) {
...
func (t *xModSnapshot) Select(bucket string, startKey []byte, endKey []byte) (ledger.XIterator, error) {
...
func (t *xModSnapshot) GetUncommited(bucket string, key []byte) (*ledger.VersionedData, error) {
	return nil, fmt.Errorf("not support")
}

func (t *xModSnapshot) genVerDataByTx(tx *protos.Transaction, offset int32) *ledger.VersionedData {
