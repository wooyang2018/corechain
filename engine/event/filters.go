...
type txFilterFunc func(*blockFilter, *protos.Transaction) bool
...
func matchIterator(filter *blockFilter, tx *protos.Transaction) bool {
	return matchString(filter.compiled.Initiator, tx.GetInitiator())
}

func matchAuthRequire(filter *blockFilter, tx *protos.Transaction) bool {
...
func matchContractName(filter *blockFilter, tx *protos.Transaction) bool {
...
func matchFromAddr(filter *blockFilter, tx *protos.Transaction) bool {
...
func matchToAddr(filter *blockFilter, tx *protos.Transaction) bool {
...
func matchTx(filter *blockFilter, tx *protos.Transaction) bool {
