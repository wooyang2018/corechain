...
func expectTxMatch(t *testing.T, tx *protos.Transaction, pbfilter *protos.BlockFilter) {
...
func expectTxNotMatch(t *testing.T, tx *protos.Transaction, pbfilter *protos.BlockFilter) {
	filter, err := newBlockFilter(pbfilter)
	if err != nil {
		t.Fatal(err)
	}
