...
func (c *Cli) initFlags() error {
	...
	rootFlag.StringVarP(&cfgFile, "conf", "C", "./conf/client.yaml", "client config file")
...
func (c *Cli) Transfer(ctx context.Context, opt *TransferOptions) (string, error) {
	...
	cryptoClient, cryptoErr := cryptoClient.CreateCryptoClient(opt.CryptoType)
	if cryptoErr != nil {
...
func computeSelectUtxoSign(bcName, account, need, initScrKey, isLock string, cryptoClient cryptoBase.CryptoClient) ([]byte, error) {
