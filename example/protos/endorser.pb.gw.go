...
func local_request_Xendorser_EndorserCall_0(ctx context.Context, marshaler runtime.Marshaler, server XendorserServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq EndorserRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.EndorserCall(ctx, &protoReq)
	return msg, metadata, err

}

// RegisterXendorserHandlerServer registers the http handlers for service Xendorser to "mux".
// UnaryRPC     :call XendorserServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterXendorserHandlerFromEndpoint instead.
func RegisterXendorserHandlerServer(ctx context.Context, mux *runtime.ServeMux, server XendorserServer) error {
	...
	mux.Handle("POST", pattern_Xendorser_EndorserCall_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Xendorser_EndorserCall_0(ctx, inboundMarshaler, server, req, pathParams)
...
func RegisterXendorserHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterXendorserHandler(ctx, mux, conn)
}

// RegisterXendorserHandler registers the http handlers for service Xendorser to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterXendorserHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterXendorserHandlerClient(ctx, mux, NewXendorserClient(conn))
}

// RegisterXendorserHandlerClient registers the http handlers for service Xendorser
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "XendorserClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "XendorserClient"
...
func RegisterXendorserHandlerClient(ctx context.Context, mux *runtime.ServeMux, client XendorserClient) error {
	...
	mux.Handle("POST", pattern_Xendorser_EndorserCall_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Xendorser_EndorserCall_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Xendorser_EndorserCall_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "endorsercall"}, ""))
)
