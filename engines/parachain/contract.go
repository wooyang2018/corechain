...
func (p *paraChainContract) handleCreateChain(ctx engineBase.TaskContext) error {
...
func (p *paraChainContract) handleStopChain(ctx engineBase.TaskContext) error {
...
func (p *paraChainContract) handleRefreshChain(ctx engineBase.TaskContext) error {
