...
func GetPolynomialForSecretShareGenerate(totalShareNumber, minimumShareNumber int) ([]*big.Int, error) {
	...
	poly, err := complexSecret.ComplexSecretToPolynomial(totalShareNumber, minimumShareNumber, secret, curve)
	if err != nil {
		return nil, err
	}
...
func GetVerifyPointByPolynomial(poly []*big.Int) (*ecc.Point, error) {
	...
	point, err := complexSecret.GetVerifyPointByPolynomial(poly, curve)
	if err != nil {
		return nil, err
	}
...
func GetSpecifiedSecretShareByPolynomial(poly []*big.Int, index *big.Int) *big.Int {
	...
	share := complexSecret.GetSpecifiedSecretShareByPolynomial(poly, index, curve)
...
func LocalSecretShareGenerateWithVerifyPoints(totalShareNumber, minimumShareNumber int) (shares map[int]*big.Int, points []*ecc.Point, err error) {
	...
	shares, points, err = complexSecret.ComplexSecretSplitWithVerifyPoints(totalShareNumber, minimumShareNumber, secret, curve)
	if err != nil {
		return nil, nil, err
	}
