...
import (
	...
	"github.com/wooyang2018/corechain/crypto/core/base58"
...
func NewMaster(seed []byte, cryptography uint8) (*ExtendedKey, error) {
	...
	// QC case secretKey ≥ n or secretKey = 0, the master key is invalid,
